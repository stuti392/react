...
const apiKey = "5f01c4c52830c6b3bc76b7e5ff7be569"
...
function Home() {
  ...
  useEffect(() => {
    ...
    //   const { data: { genre } } = await axios.get(`${url}/genre/movie/list?api_key=${apiKey}`)
    //   setgenre(genre)
  ...
  return (
    ...
    <section className='home'>
      ...
      <Row title={'Top Rated'} arr={upcomingMovies} />
